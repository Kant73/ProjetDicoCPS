 ...
 * @param c 	Caractère à insérer à la position "k"
 ...
 * @param m 	La maillon dont on veut connaître la k-ème lettre
 */
 ...
 * @param  a 	L'entier dont on veut connaître le nombre de bits
 ...
 * @param m Le maillon dont on veut connaître le nombre de lettre
 * @return 	Le nombre de lettre contenues dans le maillon
 */
int get_nb_lettres(maillon_t* m);

/**
 * @brief Convertit une chaîne de caractère en liste de maillons
 * @param chaine 	La chaîne à convertir en maillons
 * @param m  		Le maillon qui correspond à la chaîne convertie
 */
void string_to_maillon(char* chaine, maillon_t* m);

/**
 * @brief Convertit une liste de maillons en chaîne de caractères
 * @param m	La liste de maillons à convertir en chaîne de caractères
 * @return 	La liste de maillons convertie en chaîne de caractères
 */
 ...
 * Utilisation d'une fonction C existante mais qui n'est plus présente avec GCC, peut être obsolète...
 * Permet de convertir un int "value" en une string "result" qui est la représentation du "value" en base "base"
 * Non utilisée dans le projet mais utilisé durant la phase de développement pour debugger certaine fonctions
 * @param value  L'entier dont on veut la représentation dans la base "base"
 * @param result La chaîne résultat qui va contenir la représentation de "value" dans la base "base"
...
* @param m 	Le pointeur sur la tête d'une chaîne de maillons qu'on veut libérer
*/
